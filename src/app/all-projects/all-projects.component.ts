...
export class AllProjectsComponent implements OnInit {
  ...
  projects: Project[] = [
    ...
    new Project("Francesca's Italian Kitchen - The Cook Book", "We're sharing our favourite, wholesome recipes from Francesca's Italian Kitchen - Italian cooking from our kitchen to yours!", "Francesca's Italian Kitchen", 32580, "Just in time for Christmas, our gorgeous, authentic, and totally easy to use cook book will be in stores by December 2017! Featuring over 100 unique recipes from our restaurant kitchens plus dishes inspired by our journey around Italy, the book is ultimately inspired by the Italian ethos of cooking - fresh, local, exceptionally GOOD produce, cooked simply.", "Cookbooks", 3),
  ];
